...
- **[middleware-and-tenancy.md](middleware-and-tenancy.md)** — `ResolveTenant` and `EnsureUserType`, registration/order, adding protected routes per dashboard, and slug → active-team resolution end to end.

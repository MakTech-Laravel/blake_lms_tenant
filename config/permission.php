...
return [
    ...
    'column_names' => [
         ...
         *
         * This application is multi-tenant: schools are the teams, so the team
         * foreign key is `school_id`. A NULL `school_id` denotes a global
         * (platform-level) role. Teachers hold no roles at all.
         */
